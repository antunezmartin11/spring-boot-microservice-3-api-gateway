package com.mantunez.springbootmicroservice3apigateway.security;

import com.mantunez.springbootmicroservice3apigateway.model.Role;
import com.mantunez.springbootmicroservice3apigateway.security.jwt.JwtAuthorizationFilter;
   ...
   private CustomUserDetailsService customUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws  Exception
    {
        ...
        http.authorizeHttpRequests()
                ...
                .antMatchers("/api/tipoDocumento/getTipoDocumento").permitAll()
